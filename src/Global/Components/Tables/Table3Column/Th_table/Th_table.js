    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.col}>
                <Header title={props.title} color={props.color} radius='0.25rem 0 0 0.25rem'/>
            </div>

            <div className={styles.col}>
                <div className={styles.colGroup}>
                    <div style={{width: '47%'}}>
                        <Header title={props.studentsNumber} color={props.color} radius='0'/>
                    </div>

                    <div style={{width: '47%'}}>
                        {(props.studentsNumber === 0)?(
                            <Header title='0' color={props.color} radius='0 0.25rem 0.25rem 0'/>
                        ):(
