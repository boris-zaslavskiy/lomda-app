                ...
                <form className={`${styles.outerShadow}  mt-3`}>
                    <div className={`${styles.tabletSize} ${styles.whitePart} ${styles.mobileSize} pe-2`}>
                        <div className={`d-flex flex-row ${styles.topPart}`}>
                            {props.allInfo?<img src={item.avatar} width='50px' height='50px' className='me-3' alt='avatarTeacher'/>:null}
                            <div>
                        ...
                        <div className={`d-flex justify-content-end ${styles.stars}`}>
                            {props.allInfo?
                                <div><FaStar style={{color: '#F77D48'}}/></div>
                                :<StarsRating index={props.user==='student'?index:index+6} getDisabled={props.getDisabled}/>}
                        </div>
                    </div>
                    <textarea id="step_2"
                              name="step_2"
                              ...
                              className={`w-100 ${styles.greyField} ${styles.textArea}`}
                              onChange={(event) => {
